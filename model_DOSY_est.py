# -*- coding: utf-8 -*-
"""
Created on Sat Apr 25 15:50:59 2020
...
def param_gen_dosy_mostsimple(input_r, n_alphas, n_peaks, t_in, diff_range=[]):
    with tf.compat.v1.variable_scope('param_gen_dosy_experiment'):
        par_a = tf.keras.layers.Dense(units=n_alphas)(input_r)
        par_A = tf.keras.layers.Dense(units=n_alphas*n_peaks)(input_r)
        ...
        norm_C = tf.norm(C, axis=1, keepdims=True)        
